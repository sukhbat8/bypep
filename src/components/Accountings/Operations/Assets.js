...
const Assets = () => {
    ...
    const getOperations = useCallback(() => {
        PeatioApiService.getOperations(page, limit, filters).then((res) => {
    ...
    return <>
        ...
        <Table rowKey={'index'} dataSource={assets} columns={columns} onChange={onChange} pagination={{ pageSize: limit, current: page, total: totalRows }}/>
